...
function CreateContainer() {
  ...
  const saveDetails = () => {
    ...
    try {
      if (!title || !calories || !imageAsset || !price || !category) {
        ...
        setFields(true);
        setMsg('Data is uploaded succesfully');
        setAlertStatus('success');
        clearData();
        setTimeout(() => {
          setFields(false);
  ...
  return (
    <div className="w-full  flex items-center min-h-screen justify-center">
      <div className="w-[90%] md:w-75%] border border-gray-300 rounded-lg p-4 flex flex-col items-center gap-4 justify-center ">
        {fields && (
          <motion.p
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
        ...
        <div
          className=" 
         w-full py-2 border-b border-gray-200 flex items-center gap-2 "
        >
